...
uzivatel = input("Zadejte jmeno uzivatele: ")
...
vyber = input("Vyberte sluzbu: ").lower()
...
if vyber in sluzby and vyber == "dostupne filmy":
    ...
    print(oddelovac, "FILM: " + film, filmy.get(film, 'vybrany film neni v nabidce'), oddelovac, sep="\n")
